...
echo "Created .htaccess for API routing<br>\n";
...
EOT;
    ...
    echo "Created API endpoint for $table<br>\n";
}
...
echo "Created API documentation<br>\n";

echo "API generation complete!<br>\n";
?>